          ...
          <div class="col-lg-7">
              <div class="card">
                  ...
                  <div class="card mb-3">
                      <div class="card-body p-3">
                          <div class="chart">
                              <canvas id="chart-line" class="chart-canvas" height="300px"></canvas>                          </div>
                      </div>
                  </div>
              </div>
          </div>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div>
                            <img src="{{asset('../assets/img/small-logos/logo-jira.svg')}}" class="avatar avatar-sm me-3">
                          </div>
                          <div class="d-flex flex-column justify-content-center">
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div>
                            <img src="{{asset('../assets/img/small-logos/logo-invision.svg')}}" class="avatar avatar-sm me-3">
                          </div>
                          <div class="d-flex flex-column justify-content-center">
